...
class UpdateConferenceRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'remove_abstract_template' => ['nullable', 'boolean'],
            'remove_paper_template'    => ['nullable', 'boolean'],
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'start_date.required' => 'Tanggal mulai konferensi wajib diisi.',
            'end_date.required' => 'Tanggal selesai konferensi wajib diisi.',
